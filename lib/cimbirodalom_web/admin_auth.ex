defmodule CimbirodalomWeb.AdminAuth do
  use CimbirodalomWeb, :verified_routes
  ...
  @max_age 60 * 60 * 24 * 60
  @remember_me_cookie "_cimbirodalom_web_admin_remember_me"
  ...
  def log_out_admin(conn) do
    ...
    if live_socket_id = get_session(conn, :live_socket_id) do
      CimbirodalomWeb.Endpoint.broadcast(live_socket_id, "disconnect", %{})
    end
  ...
  the current_admin:
      ...
      defmodule CimbirodalomWeb.PageLive do
        use CimbirodalomWeb, :live_view

        on_mount {CimbirodalomWeb.AdminAuth, :mount_current_admin}
        ...
      end

  Or use the `live_session` of your router to invoke the on_mount callback:

      live_session :authenticated, on_mount: [{CimbirodalomWeb.AdminAuth, :ensure_authenticated}] do

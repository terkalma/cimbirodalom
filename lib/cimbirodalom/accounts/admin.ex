defmodule Cimbirodalom.Accounts.Admin do
  use Ecto.Schema
  ...
  defp maybe_validate_unique_email(changeset, opts) do
    if Keyword.get(opts, :validate_email, true) do
      changeset
      |> unsafe_validate_unique(:email, Cimbirodalom.Repo)
  ...
  """
  def valid_password?(%Cimbirodalom.Accounts.Admin{hashed_password: hashed_password}, password)

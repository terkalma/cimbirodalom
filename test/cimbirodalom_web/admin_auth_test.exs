defmodule CimbirodalomWeb.AdminAuthTest do
  use CimbirodalomWeb.ConnCase, async: true

  alias Phoenix.LiveView
  alias Cimbirodalom.Accounts
  alias CimbirodalomWeb.AdminAuth
  ...
  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, CimbirodalomWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_admin/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      CimbirodalomWeb.Endpoint.subscribe(live_socket_id)
